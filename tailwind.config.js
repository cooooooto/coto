...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Professional dual theme colors
        primary: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
      ...
      boxShadow: {
        ...
        'accent': '0 0 0 1px rgb(var(--accent) / 0.2), 0 2px 8px 0 rgb(var(--accent) / 0.1)',
        'accent-strong': '0 0 0 1px rgb(var(--accent) / 0.4), 0 4px 16px 0 rgb(var(--accent) / 0.2)',
      },
      borderRadius: {
        'xl': '0.75rem',
        '2xl': '1rem',
